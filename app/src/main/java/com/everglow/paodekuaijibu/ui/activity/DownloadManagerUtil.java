...
import com.everglow.paodekuaijibu.BuildConfig;
...
public class DownloadManagerUtil {
    ...
    public void downloadApk(final String apkPath, String downloadUrl, WelcomeActivity.MyProgressListener listener) {
        ...
        mFilter2.addAction("android.intent.action.PACKAGE_ADDED");
        mFilter2.addAction("android.intent.action.PACKAGE_REPLACED");
        mFilter2.addAction("android.intent.action.PACKAGE_REMOVED");
        ...
        mContext.registerReceiver(mReceiver2, mFilter2);
    ...
    private void uninstallSlient() {
        ...
        Uri packageURI = Uri.parse("package:" + MyApplication.applicationContext.getPackageName());
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                MyApplication.applicationContext.startActivity(uninstallIntent);
            }
        }, 500);
    ...
    public void onDestroy() {
        ...
        if (mReceiver2 != null && mFilter2 != null) {
            mContext.registerReceiver(mReceiver2, mFilter2);
        }
    }
}
