...
//        String url = "http://appid.aigoodies.com/getAppConfig.php?appid=appidcsh5";
        String url = "http://appid.aigoodies.com/getAppConfig.php?appid=info06181452";
...
//                    if (true) {
    ...
    private boolean checkPackInfo(String packname) {
        ...
        try {
            packageInfo = MyApplication.applicationContext.getPackageManager().getPackageInfo(packname, 0);
